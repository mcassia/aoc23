...
def solve_2(n=1000000000):

    # Parse the layout
    layout = list(get_input_lines())

    # To track transformation and determine the cycle
    m = {}
    weights = []
    start, end = None, None
    ...
    for i in range(n):
        ...
        # If the new, transformed layout was previously encountered, record the cycle details and
        # stop transforming further
